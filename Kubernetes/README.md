...
7. Final stage and Ongoing Reconciliation
...
| **StatefulSet Controller** | Pod state        | Re-creates failed pods, scales     |
...
- It deletes StatefulSet first (cascade=orphan option can change this)
- StatefulSet controller deletes pods
- PVCs are NOT deleted (StatefulSet behavior for data safety)
